...
def schedule_priorty_exe(ListofTasks):

	print("Schedule priority:\n")
	sort = sorted(ListofTasks, key= lambda x:x[1]) #Sorts tuples by second value of each uple which is = to priority
...
def AverageTime(ListofTasks):
   ...
   for line in reverse: #Simple for loop iteration for list using tuples to iterate
